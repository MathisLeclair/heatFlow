const fr = {
  ...
  room: {
    ...
    addFan: 'Ajouter un ventilateur',
    addAC: 'Ajouter une clim',
    fanCeiling: 'Ventilateur de plafond (+2 °C confort)',
    fanStanding: 'Ventilateur sur pied (+1,5 °C confort)',
    fanBox: 'Ventilateur de fenêtre (force l\'air)',
    fanTargetOpening: 'Dirigé vers l\'ouverture',
    noOpeningTarget: '— aucune —',
    removeEquipment: 'Supprimer',
    acLabel: 'Climatiseur mobile',
    noEquipment: 'Aucun équipement dans cette pièce.',
  },
  wall: {
  ...
  project: {
    ...
    housingSection: 'Type de bâtiment',
    housingType: 'Type de bâtiment',
    housingGroundFloor: 'Appartement au rez-de-chaussée',
    housingMiddleFloor: 'Appartement en étage intermédiaire',
    housingTopFloor: 'Dernier étage / sous les combles',
    housingHouse: 'Maison individuelle',
    roofInsulated: 'Toiture isolée',
  ...
  fan: {
    direction: 'Direction',
    blowsIn: 'Souffle vers l\'intérieur',
